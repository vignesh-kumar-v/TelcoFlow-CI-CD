...
def main(
    raw_path: Path=Path("/home/vignesh/TelecomChurn/data/raw/Telco-Customer-Churn.csv"),
    processed_path: Path=Path("/home/vignesh/TelecomChurn/data/processed/cleaned_data.parquet")
    ):
